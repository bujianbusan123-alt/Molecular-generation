...
fragment based on the frequencies in the database of ES and HS. SYBA was trained previously on ES molecules in ZINC15 database and on HS molecules generated by <br />
the Nonpher methodology. And SYBA is publicly available at https//github.com/lich-uct/syba. Here, we set the threshold of SYBA score -18.6. <br />
